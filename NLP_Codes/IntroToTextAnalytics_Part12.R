file_loc <- "C:/Users/Bal/Desktop/Eminent_Info/NLP/TextAnalyticsWithR/"
...
spam.raw <- read.csv(paste(file_loc,"spam.csv", sep = "/"), stringsAsFactors = FALSE, fileEncoding = "UTF-16")
View(spam.raw)
...
#View(train.tokens.idf[1:10, 1:10])

print(train.tokens.idf)
